...
public class MainActivity extends AppCompatActivity implements OnCompleteListener<Void> {
    ...
    private void addGeofences() {
        if (!checkPermissions()) {
            Toast.makeText(this, "Nema te Nema te...permisije al 2", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void removeGeofences() {
        if (!checkPermissions()) {
            Toast.makeText(this, "Nema te Nema te...permisije", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void populateGeofenceList() {
            ...
            mGeofenceList.add(new Geofence.Builder()
                    ...
                    .setCircularRegion(44.814158, 20.436550,
